class OneLoginResponse {
  ...
  factory OneLoginResponse.fromJson(Map<String, Object?> json) => OneLoginResponse(
...
class Data {
  ...
  factory Data.fromJson(Map<String, Object?> json) => Data(
        companies: (json['companies'] as List<Object?>?)
                ?.map((company) => Company.fromJson(company as Map<String, Object?>? ?? {}))
                .toList() ??
            [],
...
class Company {
  ...
  factory Company.fromJson(Map<String, Object?> json) => Company(
        ...
        projects: (json['projects'] as List<Object?>?)
                ?.map((project) => Project.fromJson(project as Map<String, Object?>? ?? {}))
                .toList() ??
            [],
      );
  final String id;
...
class Project {
  ...
  factory Project.fromJson(Map<String, Object?> json) => Project(
        ...
        resourceEnvironments: (json['resource_environments'] as List<Object?>?)
                ?.map((env) => ResourceEnvironment.fromJson(env as Map<String, Object?>? ?? {}))
                .toList() ??
            [],
  ...
  Map<String, Object?> toJson() => {
        ...
        'name': name,
        'domain': domain,
        'resource_environments': resourceEnvironments.map((env) => env.toJson()).toList(),
...
class ResourceEnvironment {
  ...
  factory ResourceEnvironment.fromJson(Map<String, Object?> json) => ResourceEnvironment(
        id: json['id'] as String? ?? '',
        ...
        description: json['description'] as String? ?? '',
        clientTypes: ClientTypes.fromJson(json['client_types'] as Map<String, Object?>? ?? {}),
...
class ClientTypes {
  ...
  factory ClientTypes.fromJson(Map<String, Object?> json) => ClientTypes(
        ...
        response: (json['response'] as List<Object?>?)
                ?.map((client) => ClientTypeResponse.fromJson(client as Map<String, Object?>? ?? {}))
                .toList() ??
            [],
      );
  final int count;
...
class ClientTypeResponse {
  ...
  factory ClientTypeResponse.fromJson(Map<String, Object?> json) => ClientTypeResponse(
