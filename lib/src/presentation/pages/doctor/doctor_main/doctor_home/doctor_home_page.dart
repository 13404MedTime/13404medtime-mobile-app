...
class _DoctorHomePageState extends State<DoctorHomePage> with DoctorHomePageMixin {
  @override
                                      ...
                                      return GestureDetector(
                                        onLongPress: () async {
                                          final result = await customYesNoDialog<bool?>(
                                            ...
                                            content: 'Siz rostdan ham shu vaqt oralig\'ini bekor qilmoqchimisiz',
                                        ...
                                        child: InkWell(
                                          onTap: () async {
                                            await Navigator.pushNamed(context, Routes.addFreeTime, arguments: i);
                                            if (context.mounted) {
                                                ...
                                                children: [
                                                  Text(
                                                    DateFormat('dd-MM-yyyy').format(
                                                      i.date.subtract(const Duration(days: 1)),
                                                    ),
                                                    style: TextStyle(
                                                      fontSize: 14,
                                          ...
                                          onTap: () {
                                            Navigator.pushNamed(
                                              ...
                                              arguments: DoctorRequestArguments(
                                                bookingResponse: state.requests[index],
                                                reject: () async {
                                                  final result = await showDialog<bool?>(
                                                    context: context,
                                                    builder: (context) => AlertDialog(
                                                      title: Text(
                                                        context.translate('are_you_sure_you_want_to_cancel'),
                                                        style: TextStyle(
                                                  ...
                                                  if (result != null && result == true && context.mounted) {
                                                    context.read<DoctorHomeBloc>().add(
                                                          RejectDoctorBookingRequest$DoctorHomeEvent(
                                                            requestId: state.requests[index].guid,
                                                            rejectComment: _rejectCommentController.text,
                                                          ),
                                                        );
                                                ...
                                                accept: () async {
                                                  final result = await customYesNoDialog<bool?>(
                                                    context: context,
                                                    title: context.translate('do_you_want_accept'),
                                                    content: '',
                                                    acceptOnTap: () => Navigator.pop(context, true),
                                                  );
                                                  if (result != null && result == true && context.mounted) {
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            state.requests[index].clientsIdData.clientName,
                                                            style: TextStyle(
                                                              fontSize: 16,
                                                              fontWeight: FontWeight.bold,
                                                          ...
                                                          Row(
                                                            children: [
                                                              ...
                                                              Text(
                                                                state.requests[index].clientsIdData.phone,
                                                                style: TextStyle(
                                                                  fontSize: 14,
                                                                  color: context.colorScheme.primary,
                                                                  fontWeight: FontWeight.w500,
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 8),
                                                      Text(
                                                        DateTime.parse(state.requests[index].doctorBookingIdData.date)
                                                  ...
                                                  child: InkWell(
                                                    onTap: () {
                                                      final request = state.requests.firstWhere(
                                                        (element) => element.doctorBookingIdData.guid == i.guid,
                                                      );
                                                      showDialog<Object?>(
                                                        context: context,
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child: Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            DateFormat('MMM', localSource.locale)
                                                                                .format(i.date
                                                                                    .subtract(const Duration(days: 1))),
                                                                            style: TextStyle(
                                                                              fontSize: 14,
                                                                ...
                                                                if (request.patientDescription.isNotEmpty) ...[
                                                                  const SizedBox(height: 16),
                                                                  Container(
                                                                    padding: const EdgeInsets.all(16),
                                                                    decoration: BoxDecoration(
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  DateFormat('dd')
                                                                      .format(i.date.subtract(const Duration(days: 1))),
                                                                  style: TextStyle(
                                                                    fontSize: 24,
                                                                    fontWeight: FontWeight.bold,
                                                                    color: context.colorScheme.onPrimaryContainer,
